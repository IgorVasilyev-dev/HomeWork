StudentMain1 - реализация с рандомными русскими символами
StudentMain2 - реализация с рандомными понятными именами
StudentMain3 - реализация с рандомными понятными именами загруженными из файла
