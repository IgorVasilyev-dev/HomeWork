...
import HomeWork2.arrays.ArraysForEachOperation;
...
class ArraysForEachOperationTest {

    private final ArraysForEachOperation array = new ArraysForEachOperation();

    @ParameterizedTest(name = "{index} - Новый массив = {0}")
    @DisplayName("Перебор массива ForEach")
