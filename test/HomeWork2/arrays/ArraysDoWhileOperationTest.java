...
import HomeWork2.arrays.ArraysDoWhileOperation;
...
class ArraysDoWhileOperationTest {

    private final ArraysDoWhileOperation array = new ArraysDoWhileOperation();

    @ParameterizedTest(name = "{index} - Новый массив = {0}")
    @DisplayName("Перебор массива DoWhile")
