...
import HomeWork2.arrays.ArraysForOperation;
...
class ArraysForOperationTest {

    private final ArraysForOperation array = new ArraysForOperation();

    @ParameterizedTest(name = "{index} - Новый массив = {0}")
    @DisplayName("Перебор массива For")
